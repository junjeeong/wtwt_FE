        ...
        async change(e, t, r, n, o) {
          ...
          try {
            ...
            if (B && es) {
              ...
              "/_error" === this.pathname &&
                (null == (C = self.__NEXT_DATA__.props) || null == (j = C.pageProps)
                  ? void 0
                  : j.statusCode) === 500 &&
      ...
      function ei(e) {
        ...
        return (
          ee
            ...
            : ((ee = y.default.hydrateRoot(E, P, { onRecoverableError: B.onRecoverableError })),
              (et = !1)),
          h
        )
      }
      ...
      function m(e) {
        ...
        if (
          ...
          ("beforeInteractive" === s || "worker" === s) &&
            (m
              ? ((g[s] = (g[s] || []).concat([
                  { id: t, src: r, onLoad: n, onReady: o, onError: f, ..._, nonce: E },
                ])),
                m(g))
              : b && b()
                ? d.add(t || r)
