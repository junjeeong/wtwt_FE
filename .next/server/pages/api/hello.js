;(() => {
  ...
  ;((a.id = 1),
    ...
    (a.modules = {
      1196: (a, b, c) => {
        "use strict"
        ;(c.r(b), c.d(b, { config: () => m, default: () => l, handler: () => o }))
        var d = {}
        ...
        var e = c(9046),
          ...
          h = c(6435)
        function i(a, b) {
          b.status(200).json({ name: "John Doe" })
        }
        var j = c(8112),
          k = c(8766)
        ...
        async function o(a, b, c) {
          let d = await n.prepare(a, b, { srcPage: "/api/hello" })
          if (!d) {
            ;((b.statusCode = 400),
              b.end("Bad Request"),
          ...
          try {
            let c = a.method || "GET",
              ...
              i = n.instrumentationOnRequestError.bind(n),
              l = async (e) =>
                n
                  .render(a, b, {
                    query: { ...f, ...g },
                  ...
                  .finally(() => {
                    ...
                    if (!f) return
                    if (f.get("next.span_type") !== k.BaseServerSpan.handleRequest)
                    ...
                    if (g) {
                      let a = `${c} ${g}`
                      ;(e.setAttributes({ "next.route": g, "http.route": g, "next.span_name": a }),
                        e.updateName(a))
