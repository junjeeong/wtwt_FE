...
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags""
      ...
      async function B(
        ...
        d && "allReady" in a && (await a.allReady)
        var p = [
          s(),
          t(e, h),
          v(j),
      ...
      async function E(
        a,
        { inlinedDataStream: b, getServerInsertedHTML: c, getServerInsertedMetadata: d },
      ) {
        return a
          .pipeThrough(s())
          .pipeThrough(w(c))
      ...
      class f {
        ...
        toUnchunkedBuffer(a = !1) {
          ...
          if ("string" != typeof this.response) {
            ...
            return (0, d.streamToBuffer)(this.readable)
          }
        ...
        (a.exports = ((a, f, g, h) => {
          if ((f && "object" == typeof f) || "function" == typeof f)
            for (let g of d(f))
              e.call(a, g) ||
                void 0 === g ||
                b(a, g, { get: () => f[g], enumerable: !(h = c(f, g)) || h.enumerable })
          return a
      ...
      class g {
        ...
        async get(a, b, c) {
          ...
          let {
            ...
            j = await this.batcher.batch({ key: a, isOnDemandRevalidate: e }, (j, k) => {
              let l = (async () => {
                var i
                if (
                  this.minimal_mode &&
                  (null == (i = this.previousCacheItem) ? void 0 : i.key) === j &&
                ...
                try {
                  if (
                    ...
                    return null
                  let i = await b({ hasResolved: m, previousCacheEntry: n, isRevalidating: !0 })
                  if (!i) return (this.minimal_mode && (this.previousCacheItem = void 0), null)
                  let o = await (0, f.fromResponseCacheEntry)({ ...i, isMiss: !n })
                  ...
                  if (null == n ? void 0 : n.cacheControl) {
                    let b = Math.min(Math.max(n.cacheControl.revalidate || 3, 3), 30),
                      c =
          ...
          ? {
              ...
              value:
                (null == (b = a.value) ? void 0 : b.kind) === d.CachedRouteKind.PAGES
                  ? {
                      kind: d.CachedRouteKind.PAGES,
                      html: e.default.fromStatic(a.value.html),
                      pageData: a.value.pageData,
                      headers: a.value.headers,
                      status: a.value.status,
                    }
